                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('activities.store') }}">
                        ...
                        <div>
                            ...
                            <input id="activity_id" class="block mt-1 w-full" type="text" name="activity_id" value="{{ old('activity_id') }}" required autofocus />
                        </div>
                        <div class="mt-4">
                            <label for="activity_name" class="block font-medium text-sm text-gray-700">Activity Name</label>
                            <input id="activity_name" class="block mt-1 w-full" type="text" name="activity_name" value="{{ old('activity_name') }}" required />
                        </div>
                        <div class="mt-4">
                            <label for="activity_description" class="block font-medium text-sm text-gray-700">Activity Description</label>
                            <textarea id="activity_description" class="block mt-1 w-full" name="activity_description" required>{{ old('activity_description') }}</textarea>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <button class="ml-4 inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:ring focus:ring-blue-200 active:bg-blue-600 disabled:opacity-25 transition">
                                Create Activity
                            </button>
                        </div>
                    </form>
